...
namespace CarSales
{
    ...
    public class Dealership
    {
        ...
        public Car? GetSoldCarID(int id)
        {
        ...
        public List<Car> GetCars()
        {
            ...
            foreach (Car car in cars)
            {
                carscopy.Add(new Car(car.ID, car.Brand, car.Model, car.Year, car.Price));
            }
            return carscopy;
        }
        ...
        public Customer AddCustomer(string name, string phoneno, string address, string zipcodecity)//databasehandler
        {
